...
@section('content')
    ...
    <div class="jumbotron">
        ...
        Its programs are recognized by the Commission on Higher Education (CHED), and Technical Education and Skills Development Authority (TESDA).
St. Nicolas College of Business and Technology (SNC) is committed to produce professionals, technical leaders and entrepreneurs who have high regard for self-respect, service to fellowmen, preservation and conservation of environment and love of country for the glorification of the Creator.
        </p>
        <hr class="my-4">
        <p>
